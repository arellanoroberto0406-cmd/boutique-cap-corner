            ...
            <CardContent className="pt-8 text-center">
              ...
              {paymentMethod === "transfer" && (
                <div className="bg-secondary rounded-lg p-6 text-left mb-6">
                  ...
                  {/* Información para copiar y enviar */}
                  <div className="mt-4 p-4 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg">
                    <p className="text-sm font-medium text-green-800 dark:text-green-200 mb-2">
                      📋 Copia estos datos para enviar junto con tu comprobante:
                    </p>
                    <div className="bg-background rounded p-3 mb-3">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="font-mono font-bold text-primary">{speiReference}</span>
                          <Button size="icon" variant="ghost" className="h-6 w-6" onClick={() => copyToClipboard(speiReference)}>
                            <Copy className="h-3 w-3" />
                          </Button>
                        </div>
                      </div>
                  ...
                  <div className="mt-4">
                    <a
                      href={`https://wa.me/526692646083?text=${encodeURIComponent(`¡Hola! Ya realicé mi pago.\n\n📦 *PEDIDO:* ${orderId.slice(0, 8).toUpperCase()}\n🔢 *REFERENCIA:* ${speiReference}\n💰 *MONTO:* $${displayTotal.toFixed(2)}\n\n📎 Adjunto mi comprobante de pago.`)}`}
                      target="_blank"
                  ...
                  <div className="text-center">
                    <p className="text-xs text-muted-foreground mb-2">¿Prefieres enviar tu comprobante por WhatsApp?</p>
                    <a
                      href={`https://wa.me/526692646083?text=${encodeURIComponent(`¡Hola! Ya realicé mi pago.\n\n📦 *PEDIDO:* ${orderId.slice(0, 8).toUpperCase()}\n🔢 *REFERENCIA:* ${speiReference}\n💰 *MONTO:* $${displayTotal.toFixed(2)}\n\n📎 Adjunto mi comprobante de pago.`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
              ...
              {paymentMethod === "oxxo" && (
                <div className="bg-secondary rounded-lg p-6 text-left mb-6">
                  ...
                  <div className="text-center">
                    <p className="text-xs text-muted-foreground mb-2">¿Prefieres enviar tu comprobante por WhatsApp?</p>
                    <a
                      href={`https://wa.me/526692646083?text=${encodeURIComponent(`¡Hola! Ya realicé mi pago en OXXO.\n\n📦 *PEDIDO:* ${orderId.slice(0, 8).toUpperCase()}\n💰 *MONTO:* $${displayTotal.toFixed(2)}\n\n📎 Adjunto mi comprobante de pago.`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Button variant="outline" size="sm" className="text-green-600 border-green-600 hover:bg-green-50">
              ...
              {paymentMethod === "kiosko" && (
                <div className="bg-secondary rounded-lg p-6 text-left mb-6">
                  ...
                  <div className="text-center">
                    <p className="text-xs text-muted-foreground mb-2">¿Prefieres enviar tu comprobante por WhatsApp?</p>
                    <a
                      href={`https://wa.me/526692646083?text=${encodeURIComponent(`¡Hola! Ya realicé mi pago en Kiosco.\n\n📦 *PEDIDO:* ${orderId.slice(0, 8).toUpperCase()}\n💰 *MONTO:* $${displayTotal.toFixed(2)}\n\n📎 Adjunto mi comprobante de pago.`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Button variant="outline" size="sm" className="text-green-600 border-green-600 hover:bg-green-50">
